...
charts['expenses'] = new App.Models.Chart({backgroundColor: 'light-blue lighten-2', title: "Expenses per category", canvasId: 'expensesPerCategory', legendClass: 'expenses-legend'});
